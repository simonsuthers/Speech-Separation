'''
Script to train bi-directional RNN model
'''
...
with tf.Session() as sess:
    ...
    for epoch in range(training_epochs):
        ...
        for i in range(0, total_batches):
            ...
            _, loss1, accuracy1, outputs11, state_concate11, out_concate1 = sess.run([train_step, loss, accuracy, outputs1, state_concate1, out_concate], feed_dict={X: tr_features, Y:Y_labels})
...
plt.tight_layout()
fig.savefig("bidirnnaccuracy.png", bbox_inches="tight")
plt.show()
plt.close(fig)  
...
plt.tight_layout()
fig.savefig("bidirnnibm.png", bbox_inches="tight")
plt.show()
plt.close(fig)
...
#Save figure
plt.tight_layout()
fig.savefig("bidirnnrecoveredwav.png", bbox_inches="tight")
plt.show()
plt.close(fig)
